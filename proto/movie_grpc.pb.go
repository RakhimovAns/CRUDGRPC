...
type MovieServiceClient interface {
	CreatedMovie(ctx context.Context, in *CreateMovieRequest, opts ...grpc.CallOption) (*CreateMovieResponse, error)
	...
	UpdateMovies(ctx context.Context, in *UpdateMovieRequest, opts ...grpc.CallOption) (*UpdateMovieResponse, error)
...
func (c *movieServiceClient) CreatedMovie(ctx context.Context, in *CreateMovieRequest, opts ...grpc.CallOption) (*CreateMovieResponse, error) {
	out := new(CreateMovieResponse)
	err := c.cc.Invoke(ctx, "/proto.MovieService/CreatedMovie", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *movieServiceClient) UpdateMovies(ctx context.Context, in *UpdateMovieRequest, opts ...grpc.CallOption) (*UpdateMovieResponse, error) {
	out := new(UpdateMovieResponse)
	err := c.cc.Invoke(ctx, "/proto.MovieService/UpdateMovies", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieServiceServer interface {
	CreatedMovie(context.Context, *CreateMovieRequest) (*CreateMovieResponse, error)
	...
	UpdateMovies(context.Context, *UpdateMovieRequest) (*UpdateMovieResponse, error)
...
func (UnimplementedMovieServiceServer) CreatedMovie(context.Context, *CreateMovieRequest) (*CreateMovieResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreatedMovie not implemented")
}
...
func (UnimplementedMovieServiceServer) UpdateMovies(context.Context, *UpdateMovieRequest) (*UpdateMovieResponse, error) {
...
func _MovieService_CreatedMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateMovieRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServiceServer).CreatedMovie(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MovieService/CreatedMovie",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).CreatedMovie(ctx, req.(*CreateMovieRequest))
	}
...
func _MovieService_UpdateMovies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateMovieRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServiceServer).UpdateMovies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.MovieService/UpdateMovies",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).UpdateMovies(ctx, req.(*UpdateMovieRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MovieService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "CreatedMovie",
			Handler:    _MovieService_CreatedMovie_Handler,
		},
		{
			MethodName: "GetMovie",
		...
		},
		{
			...
			Handler:    _MovieService_UpdateMovies_Handler,
		},
		{
